...
if strangle_search=="y":
    file_name=f"../output/{ver_name}_{name_of_file}_strangled_{xyz}.json"
    file_name1=f"../output/{ver_name}_{name_of_file}_strangled_{xyz}_least_flags.json"
else:
    file_name=f"../output/{ver_name}_{name_of_file}_{xyz}.json"
    file_name1=f"../output/{ver_name}_{name_of_file}_{xyz}_least_flags.json"
    #file_name = f"./output/
